...
.OAMBlock:
; tile ID, attributes
	db $fc, OAM_OBP1 | 6 ; Uses palette 6 (green, specifically for cut trees)
	db $fd, OAM_OBP1 | 6 ; Uses palette 6 (green, specifically for cut trees)
	db $fe, OAM_OBP1 | 6 ; Uses palette 6 (green, specifically for cut trees)
